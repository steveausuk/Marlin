...
//
  ...
  #define TRAMMING_POINT_XY { {  (X_MIN_POS+30), (Y_MIN_POS+30) }, { (X_MAX_POS-30),  (Y_MIN_POS+30) }, { (X_MAX_POS-20), (Y_MAX_POS-20) }, { (X_MIN_POS+20), (X_MAX_POS-20) } }
...
// Full Set of 8 vtools for mixt
  #define STARTUP_COMMANDS "M164 S0\nM163 S0 P0\nM163 S1 P1\nM163 S2 P0\nM164 S1\nM163 S0 P0\nM163 S1 P0\nM163 S2 P1\nM164 S2\nM163 S0 P0.33\nM163 S1 P0.33\nM163 S2 P0.34\nM164 S3\nM163 S0 P0.25\nM163 S1 P0.75\nM163 S2 P0\nM164 S4\nM163 S0 P0\nM163 S1 P0.75\nM163 S2 P0.25\nM164 S5\nM163 S0 P0\nM163 S1 P0.50\nM163 S2 P0.50\nM164 S6\nM163 S0 P0.50\nM163 S1 P0.50\nM163 S2 P0\nM164 S7\nM163 S0 P1\nM163 S1 P0\nM163 S2 P0\n"
#endif
